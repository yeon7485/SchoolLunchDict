...
public class FridayFragment_T extends Fragment {
    ViewPager viewPager;
            ...
            public void run() {
                ...
                try{
                    ...
                    if(!isEmpty) { //null값이 아니면 크롤링 실행
                        Element lunchMenu = doc.select("td.alignL").get(8);
                        Element dinnerMenu = doc.select("td.alignL").get(9);
